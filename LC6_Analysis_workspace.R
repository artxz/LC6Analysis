...
# downstream neurons naming manuscript --> code: LC6G1 --> bi, LC6G2 --> ipsi 
...
# this load the workspace, if you wanna make figures with minimal processing ----------------------------------------

# # Need to re-run individual sections to update the varibles used in figures.
# load("LC6_Analysis_workspace.RData")


# loaded raw data variables, if you want to run all the code  -----------------------------------------------

load("LC6_Analysis_data.RData")

# main variable are the following

# "buchner" is Buchner 71 eye map from Andrew Straw
buchner_phi <- c(-10, 160) # longitude range within +/-20 degree of the equator

# "LC6" is the list of LC6 neurons
# "TM5" is list of 2 TM5 neurons
# "neu_target" is the list of LC6 downstream neurons
# "neu_biL" and "neu_biR" are LCG1 neurons
# "neu_ipsi" are LCG2 neurons

# "glo_vol" is the LC6 glomerulus volumne mesh 
# "v14" is the whole brain mesh

# "LC6_pre", "LC6_post", "LC6LC6" are the pre-/post-synapses and LC6-LC6 synapses, eg. inspect `head(LC6LC6)`
# "dist_Nconn" is synapse-weighted LC6-LC6 distance, for Figure 5E
# "conn_target" is the LC6-target neuron connectivity
# "conn_LC6_tar" also contains LC6-target neuron connectivity information, but differennt content
...
# LC6G1
expBi3 <- readMat("ss825_bi_RF_indiv_tseries.mat") #bi
expBi3 <- expBi3[[1]]
expBi <- readMat("ss825_mean_RFmap_n=4.mat") #bi
expBi <- as.matrix(expBi[[1]])


expIpsi3 <- readMat("ss2036_ipsi_RF_indiv_tseries.mat") #ipsi
expIpsi3 <- expIpsi3[[1]]
expIpsi <- readMat("ss2036_mean_RFmap_n=7.mat") #ipsi
